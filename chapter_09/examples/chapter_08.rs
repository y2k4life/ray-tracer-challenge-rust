...
fn main() {
    ...
    world.add_object(Box::new(wrist));
    ...
    world.add_object(Box::new(finger1));
    ...
    world.add_object(Box::new(finger2));
    ...
    world.add_object(Box::new(finger3));
    ...
    world.add_object(Box::new(finger4));
