...
fn main() {
    ...
    shape.transform = Transformation::new()
        ...
        .rotate_z(PI / 4.0)
        .build();
    draw_shape(&shape, "ch_06_shrink_rotate.ppm");
    ...
    shape.transform = Transformation::new()
        ...
        .build();
    draw_shape(&shape, "ch_06_shrink_skew.ppm");
}
