use crate::{shapes::Shape, Computations, Ray, EPSILON};
...
impl<'a> Intersection<'a> {
    ...
    pub fn prepare_computations<'h>(&'h self, r: Ray, xs: &[Intersection]) -> Computations<'h> {
...
mod tests {
    use super::*;
    use crate::{
        float_eq, shapes::Plane, shapes::Sphere, Point, Ray, Transformation, Vector, EPSILON,
    };
