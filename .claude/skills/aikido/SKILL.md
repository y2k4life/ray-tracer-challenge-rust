---
name: aikido
description: This skill should be used whenever Claude generates, modifies, or adds first-party code. Automatically runs Aikido security scans on changed code to detect vulnerabilities.
version: 1.0.0
